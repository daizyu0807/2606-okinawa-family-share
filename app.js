      ...
      days: [
        {
          day: "D6",
          date: "6/11（四）",
          title: "恩納退房、先西來院達磨寺、牧志市場晚午餐與那霸入住",
          items: [
            { time: "08:00-09:00", label: "早餐：飯店自助早餐會場", duration: "約 60 分", desc: "6/11 早餐使用飯店自助早餐會場，吃完再整理退房行李。" },
            { time: "09:15", label: "恩納退房", duration: "目標時間", desc: "預計 09:15 退房出發，先往首里 / 那霸方向，不再繞豐崎；把 DMM 留到隔天早上搶餵食券。" },
            { time: "09:15-10:45", label: "恩納 → 西來院達磨寺（西来院）", duration: "約 75-90 分", desc: "早上吃很飽，先跑參拜點，把午餐往後放。" },
            { time: "10:45-11:45", label: "西來院達磨寺（西来院）", duration: "約 45-60 分", desc: "達磨與祈願景點；首里站附近，兩台車停車位有限，現場不好停就縮短停留。" },
            { time: "11:45-12:30", label: "往牧志 / 飯店周邊移動", duration: "約 30-45 分", desc: "往牧志市場或飯店周邊移動，視停車與行李狀況調整。" },
            { time: "12:45-14:15", label: "晚午餐：第一牧志公設市場", duration: "約 90 分", desc: "早上早餐吃很飽，午餐延後；8 人可用 2 樓桌位處理，不趕用餐。" },
            { time: "14:30-15:30", label: "入住逸之彩", duration: "約 30-60 分", desc: "辦理入住、整理行李與雨具，讓明天一早能準時出門。" },
            { time: "16:00 後", label: "國際通 / 唐吉訶德 / 飯店休息", duration: "彈性", desc: "市區採買和休息彈性處理；晚餐可用人生酒場、國際通輕食或飯店宵夜拉麵。" }
          ],
          note: "D6 改成換飯店與那霸市區整理日，先去西來院達磨寺，再晚一點吃牧志市場；DMM 留到明天早上專心搶餵食券。"
        },
        {
          day: "D7",
          date: "6/12（五）",
          title: "DMM 餵食券優先、iias 午餐，下午看天氣接瀨長島",
          items: [
            ...
            { time: "11:30-12:30", label: "午餐：iias 沖繩豐崎美食街", duration: "約 60 分", desc: "DMM 與 iias 同區停車，8 人可分流用餐；若餵食券時段在中午附近，午餐就前後微調。" },
            { time: "12:30-13:30", label: "iias 短逛 / 回 DMM 餵食體驗", duration: "約 60 分", desc: "依餵食券時間決定回水族館或留商場休息，避免下午行程壓太滿。" },
            { time: "14:00-16:30", label: "晴天：瀨長島 Umikaji Terrace / 雨天：留 iias 或回國際通", duration: "約 2-2.5 小時", desc: "晴天再接瀨長島看海與飛機；雨天不硬跑海邊，改 iias 室內或回國際通。" },
            { time: "17:00 後", label: "回飯店休息 / 國際通彈性晚餐", duration: "彈性", desc: "晚上不排正式大餐，可用國際通輕食、暖暮、肉屋ししや、琉球美麗雪或飯店宵夜。" }
          ],
          note: "D7 以 DMM 09:00 入場與餵食券為硬限制；其他行程都依餵食體驗時間、天氣與體力調整。"
        },
        {
          day: "D8",
          date: "6/13（六）",
    ...
    },
    {
      ...
      places: [
        ...
        },
        {
          ...
          description: "D6 牧志市場後可選短停；多數資料寫 07:00-18:00，若雨太大或體力不足就跳過。"
        },
        {
          name: "壺屋やちむん通",
          badges: ["sunny", "food"],
  ...
  naha: [
    {
      day: "D6",
      date: "6/11（四）",
      title: "雨天版：先西來院可短停，再接牧志市場與那霸入住",
      items: [
        { time: "08:00-09:00", label: "早餐：飯店自助早餐會場", duration: "約 60 分", desc: "雨天先把早餐和退房節奏整理好，行李與雨具分開放。" },
        { time: "09:15", label: "恩納退房", duration: "目標時間", desc: "預計 09:15 退房後往首里 / 那霸方向，不臨時加海邊或豐崎點。" },
        { time: "09:15-10:45", label: "恩納 → 西來院達磨寺（西来院）", duration: "約 75-90 分", desc: "小雨可照排；雨大就直接往牧志或飯店周邊移動。" },
        { time: "10:45-11:45", label: "西來院達磨寺（西来院）/ 雨大跳過", duration: "約 45-60 分", desc: "雨大或不好停就縮短或取消，避免全員淋雨。" },
        { time: "11:45-12:30", label: "往牧志 / 飯店周邊移動", duration: "約 30-45 分", desc: "抵達後先休息、找停車或寄放行李。" },
        { time: "12:45-14:15", label: "晚午餐：第一牧志公設市場", duration: "約 90 分", desc: "早餐吃很飽，午餐延後；室內市場與食堂比戶外點穩。" },
        { time: "14:30-15:30", label: "入住逸之彩", duration: "約 30-60 分", desc: "先整理行李與雨具，明天早上才能準時出門 DMM。" },
        { time: "16:00 後", label: "國際通室內採買 / 飯店休息", duration: "彈性", desc: "唐吉訶德、國際通可短逛；雨大就回飯店宵夜，不排正式大餐。" }
      ],
      note: "雨天版 D6 仍以 09:15 退房、首里 / 牧志 / 入住為主；西來院視雨勢縮短或跳過。"
    },
    {
      day: "D7",
      date: "6/12（五）",
      title: "雨天版：DMM 餵食券優先，下午改室內備案",
      items: [
        ...
        { time: "11:30-12:30", label: "午餐：iias 沖繩豐崎美食街", duration: "約 60 分", desc: "同區餐飲分流，停車不用移動；若餵食體驗時間卡中午，午餐前後微調。" },
        { time: "12:30-14:00", label: "iias 室內休息 / 回 DMM 餵食體驗", duration: "約 1-1.5 小時", desc: "雨天不急著離開豐崎，同區完成體驗、休息與補逛。" },
        { time: "14:00-16:30", label: "唐吉訶德國際通店 / 國際通室內採買", duration: "約 2-2.5 小時", desc: "雨天取消瀨長島，回市區補採買與甜點休息。" },
        { time: "17:00 後", label: "晚餐：暖暮 / 國際通輕食 / 飯店宵夜", duration: "彈性", desc: "晚餐不排正式大餐；雨大就回飯店宵夜。" }
      ],
      note: "雨天版 D7 同樣優先 DMM 餵食券；下午取消瀨長島，改 iias 和國際通室內點。"
    },
    {
      day: "D8",
      date: "6/13（六）",
