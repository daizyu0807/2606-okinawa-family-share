    ...
    },
    {
      ...
      days: [
        ...
        },
        {
          day: "D7",
          date: "6/12（五）",
          title: "西來院達磨寺、牧志市場海鮮，瀨長島半日",
          items: [
            { time: "09:00-10:00", label: "西來院達磨寺（西来院）", duration: "約 45-60 分", desc: "國際通店家多還沒開時先排首里短停；多數資料寫 07:00-18:00，保守以 09:00 後參拜。建議搭單軌到首里站再步行約 5 分鐘，兩台車停車位有限。" },
            { time: "10:15-11:00", label: "返回牧志 / 國際通周邊", duration: "約 45 分", desc: "回市區接牧志市場午餐；若達磨寺停留較久，就直接前往市場，不硬逛國際通。" },
          ...
          note: "D7 早上利用國際通尚未完全開店的空檔排西來院達磨寺；若當天雨大或不想搭單軌，就跳過直接接牧志市場。"
        },
        {
          day: "D8",
          date: "6/13（六）",
    ...
    },
    {
      ...
      places: [
        ...
        },
        {
          ...
          description: "D7 早上已排入主行程；多數資料寫 07:00-18:00，行程保守抓 09:00 後參拜。若雨太大或不想搭單軌就跳過。"
        },
        {
          name: "壺屋やちむん通",
          badges: ["sunny", "food"],
...
const rainyScheduleDays = {
  ...
  naha: [
    ...
    },
    {
      day: "D7",
      date: "6/12（五）",
      title: "雨天版：西來院可跳過，牧志市場與國際通室內收尾",
      items: [
        { time: "09:00-10:00", label: "西來院達磨寺（西来院）/ 飯店晚出門", duration: "約 45-60 分", desc: "小雨可照排，保守以 09:00 後參拜；雨大或長輩不想移動就取消，直接晚點出門接牧志市場。" },
        { time: "10:15-11:00", label: "返回牧志 / 國際通周邊", duration: "約 45 分", desc: "只走可快速進店的路線；若西來院取消，就把這段改成飯店休息。" },
