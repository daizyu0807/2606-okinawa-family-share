      ...
      days: [
        {
          day: "D6",
          date: "6/11（四）",
          title: "恩納退房、Island Club 青洞確認、寺廟與牧志晚午餐",
          items: [
            ...
            { time: "10:00-12:15", label: "Island Club 青之洞窟浮潛 / 真榮田岬替代", duration: "約 1-2 小時", desc: "能浮潛就走青之洞窟；若海況不行或不能下水，就改真榮田岬展望台、步道短逛，不硬下水。" },
            { time: "12:15-13:30", label: "真榮田 / 恩納 → 西來院達磨寺（西来院）", duration: "約 60-75 分", desc: "浮潛後直接南下首里；若沒浮潛，這段可提前出發。" },
            { time: "13:30-14:15", label: "西來院達磨寺（西来院）", duration: "約 45 分", desc: "達磨與祈願景點；首里站附近，兩台車停車位有限，現場不好停就縮短停留。" },
            { time: "14:15-14:45", label: "往牧志 / 飯店周邊移動", duration: "約 30 分", desc: "往牧志市場或飯店周邊移動，視停車與行李狀況調整。" },
            { time: "15:00-16:15", label: "晚午餐：第一牧志公設市場", duration: "約 75 分", desc: "早餐吃很飽，加上先跑青洞 / 真榮田岬，牧志市場改晚午餐；8 人可用 2 樓桌位處理。" },
            { time: "16:30-17:00", label: "入住逸之彩", duration: "約 30 分", desc: "辦理入住、整理行李與雨具，讓明天一早能準時出門。" },
            { time: "17:00 後", label: "國際通 / 唐吉訶德 / 飯店休息", duration: "彈性", desc: "市區採買和休息彈性處理；晚餐可用人生酒場、國際通輕食或飯店宵夜拉麵。" }
          ],
          note: "D6 先看 Island Club 青洞浮潛能否成行；不能下水就真榮田岬短逛，再南下西來院達磨寺與牧志市場。"
        },
        {
          day: "D7",
          date: "6/12（五）",
    ...
    },
    {
      ...
      places: [
        ...
        },
        {
          ...
          description: "D6 青洞 / 真榮田岬後南下短停；多數資料寫 07:00-18:00，若雨太大或體力不足就縮短。"
        },
        {
          name: "壺屋やちむん通",
          badges: ["sunny", "food"],
  ...
  naha: [
    {
      day: "D6",
      date: "6/11（四）",
      title: "雨天版：先確認青洞，不能下水就真榮田岬 / 直接南下",
      items: [
        ...
        { time: "10:00-12:15", label: "青之洞窟浮潛 / 真榮田岬 / 直接南下", duration: "約 1-2 小時", desc: "可下水才浮潛；不能下水且雨勢可接受就真榮田岬短逛，雨大則直接南下。" },
        { time: "12:15-13:30", label: "真榮田 / 恩納 → 西來院達磨寺（西来院）", duration: "約 60-75 分", desc: "視浮潛結束時間南下首里；若雨大可縮短寺廟停留。" },
        { time: "13:30-14:15", label: "西來院達磨寺（西来院）/ 雨大縮短", duration: "約 45 分", desc: "雨大或不好停就縮短，避免全員淋雨。" },
        { time: "14:15-14:45", label: "往牧志 / 飯店周邊移動", duration: "約 30 分", desc: "抵達後先休息、找停車或寄放行李。" },
        { time: "15:00-16:15", label: "晚午餐：第一牧志公設市場", duration: "約 75 分", desc: "早餐吃很飽，午餐延後；室內市場與食堂比戶外點穩。" },
        { time: "16:30-17:00", label: "入住逸之彩", duration: "約 30 分", desc: "先整理行李與雨具，明天早上才能準時出門 DMM。" },
        { time: "17:00 後", label: "國際通室內採買 / 飯店休息", duration: "彈性", desc: "唐吉訶德、國際通可短逛；雨大就回飯店宵夜，不排正式大餐。" }
      ],
      note: "雨天版 D6 先以 Island Club 現場判斷為準；不能浮潛就改真榮田岬短逛或直接南下。"
    },
    {
      day: "D7",
      date: "6/12（五）",
